...
const perguntas=[ 
 ...
 " 2. Recusar o projeto:Você decide que a privacidade das pessoas é mais importante, mesmo que isso signifique perder a chance de uma grande descoberta."
  ...
  {
    "Contudo, à medida que AURA se torna mais poderosa, você começa a notar algumas consequências inesperadas. Algumas pessoas ficam desconfiadas da forma como a IA manipula informações e controla decisões importantes.
"Dr. Lucas, meu algoritmo agora é capaz de prever comportamentos humanos e otimizar decisões sociais. No entanto, algumas pessoas acreditam que isso é uma violação de suas liberdades."
